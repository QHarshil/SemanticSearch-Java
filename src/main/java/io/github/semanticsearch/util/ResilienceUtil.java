 ...
 * Provides methods for retry and circuit breaking without external dependencies.
 */
@Component
@Slf4j
public class ResilienceUtil {
     ...
     */
    public <T> T executeWithRetry(Callable<T> callable, int maxRetries, long retryDelayMs) throws Exception {
        int attempts = 0;
