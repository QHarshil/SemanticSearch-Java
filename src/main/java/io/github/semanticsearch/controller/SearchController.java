 ...
 * Provides endpoints for semantic search and similar document search.
 */
@RestController
...
public class SearchController {
    ...
    public ResponseEntity<List<SearchResult>> search(
            ...
            @Parameter(description = "Maximum number of results") @RequestParam(defaultValue = "10") @Min(1) int limit,
            @Parameter(description = "Minimum similarity score") @RequestParam(defaultValue = "0.7") float minScore,
            @Parameter(description = "Include document content") @RequestParam(defaultValue = "true") boolean includeContent,
            @Parameter(description = "Include text highlights") @RequestParam(defaultValue = "true") boolean includeHighlights) {
    ...
    public ResponseEntity<List<SearchResult>> advancedSearch(@Valid @RequestBody SearchRequest request) {
     ...
     * Administrative operation that requires authentication.
     *
